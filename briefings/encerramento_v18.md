# 🌿 NAMI — Contexto do Projeto (v18 — becos sem saída do `configuracao.js` eliminados (BUG-032/033), escalada inteligente ao classificador central desenhada e implementada, BUG-060/062/063/064 corrigidos (interpretação de mudança de intenção) — 10/07/2026)
...
- **Google Drive:** pasta Desenvolvimento Nami, ID `17uNtuBHOHw41FBc0zxZjx_-kjTW7bRmN`. Último relatório: `Nami_Relatorio_v18.docx`.
