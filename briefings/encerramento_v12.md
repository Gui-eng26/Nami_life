# Briefing de Encerramento — Sessão v12

## Instruções para o Claude Code

Você receberá este arquivo ao final da sessão v12 de desenvolvimento da Nami.
...
```bash
git add CONTEXT.md
git commit -m "docs: CONTEXT.md atualizado — sessão v12 (02/07/2026)"
git push
```
