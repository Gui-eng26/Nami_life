# 🌿 NAMI — Contexto do Projeto (v19 — BUG-065 corrigido (alerta de estoque pós-confirmação unificado em `templates/estoqueTemplates.js`), MH-049/050 registrados, higiene de nome de repositório resolvida (`nami-backend` → `Nami_life`/`nami_life`) — 13/07/2026)
...
- **Google Drive:** pasta Desenvolvimento Nami, ID `17uNtuBHOHw41FBc0zxZjx_-kjTW7bRmN`. Último relatório: `Nami_Relatorio_v19.docx`.
